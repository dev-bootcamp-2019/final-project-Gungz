    ...
    return (
      <main className="container">
        <div className="pure-g">
          ...
          <div className="pure-u-1-1">
            <h2>Bounties</h2>
            <p>Let's check Bounties</p>
            <p><strong>Contract Name</strong>: <ContractData contract="Bounties" method="contractName" /></p>
            <p><strong>Number of Job</strong>: <ContractData contract="Bounties" method="numJob" /></p>
